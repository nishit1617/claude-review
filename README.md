...
- Mark a file as viewed once you've gone through it, separately from accepting or rejecting anything in it, so you can track your own progress through a large set of changes without it affecting what actually gets kept
...
4. Work through the file list in the sidebar in whatever order you like. For each file, accept or reject what you want, check it off as viewed once you're satisfied with it, and leave a short reason on anything you reject.
5. Click **Apply Review**. Rejected changes are reverted; everything else stays as Claude left it. This works regardless of whether every file has been marked viewed.
